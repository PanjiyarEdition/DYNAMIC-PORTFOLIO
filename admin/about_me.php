...
<div class="row">
                ...
                <form action="about_me_update.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="twitter_link"
                            value="<?=$about_me_data['twitter_link']?>">
                    </div>
    ...
    <div class="col-4 mx-auto">
        ...
        <table class="table-bordered text-center mb-2" width="100%">
            ...
            <tr>
                <td>
                    <img class="mt-0 mb-2" src="image/profile/<?=$about_me_data['photo']?>" alt="profile image"
                        width='250'>
                </td>
            </tr>
