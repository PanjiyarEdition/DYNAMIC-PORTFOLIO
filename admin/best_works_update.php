...
<div class="row">
    ...
    <div class="col-4 mx-auto">
        ...
        <table class="table-bordered text-center mb-2" width="100%">
            ...
            <tr>
                <td>
                    <img class="mt-0 mb-2" src="image/my_best_works/<?=$best_works_data['photo']?>" alt="profile image"
                        width='200'>
                </td>
            </tr>
        ...
        <form action="best_works_update_check.php?id=<?=base64_encode($id)?>" enctype="multipart/form-data"
            method="post">
