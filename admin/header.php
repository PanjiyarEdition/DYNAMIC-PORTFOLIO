            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div class="user-box">
                 ...
                 ?>
                        ...
                        <img src="image/users/<?=$photo_from_db['photo']?>" alt="user-img" title="Mat Helme"
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="far fa-address-card"></i> <span> About me
                                </span></a>
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fas fa-envelope-square"></i> <span> Contact
                                    Information</span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                ...
                                <img src="image/users/<?=$photo_from_db['photo']?>" alt="user" class="rounded-circle">
                                <span class="ml-1"><?=$_SESSION['user_name']?> <i class="mdi mdi-chevron-down"></i>
                                </span>
                            </a>
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li>
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="../index.php">Panjiyar_Edition</a></li>
