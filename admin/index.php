...
$title = "DASHBOARD - PANJIYAR_EDITION";
    ...
    <div class="col-sm-12">
        ...
        <div class="profile-user-box card-box bg-info">
            <div class="row text-dark">
                <div class="col-sm-6">
                    <span class="float-left mr-2"><img src="image/users/<?=$row['photo']?>" alt="profile_photo"
                            width='100' class="avatar-xl rounded-circle"></span>
                ...
                <ul class="social-links list-inline mt-4 mb-0 mx-auto">
                    <li class="list-inline-item">
                        <a title="" data-placement="top" data-toggle="tooltip" class="tooltips"
                            href="<?=$result['fb_link']?>" data-original-title="Facebook"><i
                                class="fab fa-facebook-f"></i></a>
                    </li>
                    <li class="list-inline-item">
                        <a title="" data-placement="top" data-toggle="tooltip" class="tooltips"
                            href="<?=$result['twitter_link']?>" data-original-title="Twitter"><i
                                class="fab fa-twitter"></i></a>
                    </li>
                    <li class="list-inline-item">
                        <a title="" data-placement="top" data-toggle="tooltip" class="tooltips"
                            href="<?=$result['github_link']?>" data-original-title="Github"><i
                                class="fab fa-github"></i></a>
                    </li>

                    <li class="list-inline-item">
                        <a title="" data-placement="top" data-toggle="tooltip" class="tooltips"
                            href="<?=$result['linkedin_link']?>" data-original-title="Linkedin"><i
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-sm btn-warning"
                                    href="best_works_update.php?id=<?=base64_encode($result['id'])?>">Update</a>
                                <a class="btn btn-sm btn-danger"
                                    href="best_works_delete.php?id=<?=base64_encode($result['id'])?>">Delete</a>
                            </div>
                        </td>
                    </tr>
