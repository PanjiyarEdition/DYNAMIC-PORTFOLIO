...
<body class="account-pages">
    ...
    <!-- Begin page -->
    <div class="accountbg"
        style="background: url('assets/images/banner.jpg');background-size: cover;background-position: center;"></div>
    ...
    <div class="wrapper-page account-page-full">
                    ...
                    <div class="card-box p-5">
                        <h2 class="text-uppercase text-center pb-4">
                            <a href="../index.php" class="text-success">
                                <span><img src="assets/images/banner.jpg" alt="" height="26"> Panjiyar_Edition</span>
                            </a>
                        </h2>
                        ...
                        <div class="text-center m-b-20">
                            ...
                            <p class="text-muted font-14 m-t-10"> You are now successfully sign out. Back to <a
                                    href="../login.php" class="text-dark m-r-5"><b>Sign In</b></a></p>
                        </div>
        ...
        <div class="m-t-40 text-center">
            <p class="account-copyright">2023 © Panjiyar_Edition</p>
        </div>
