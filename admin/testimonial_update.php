...
<div class="row">
                ...
                <form action="testimonial_update_check.php?id=<?=base64_encode($id)?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="customer_desegnation"
                            value="<?=$testimonial_data['customer_desegnation']?>">
                    </div>

                    <div class="form-group">
                        <label for="project_catagory">Customer Comments</label>
                        <textarea name="customer_comment"
                            class="form-control"><?=$testimonial_data['customer_comment']?></textarea>
                    </div>
    ...
    <div class="col-4 mx-auto">
        ...
        <table class="table-bordered text-center mb-2" width="100%">
            ...
            <tr>
                <td>
                    <img class="mt-0 mb-2" src="image/customers/<?=$testimonial_data['photo']?>" alt="profile image"
                        width='220'>
                </td>
            </tr>
        ...
        <form action="testimonial_update_check.php?id=<?=base64_encode($id)?>" enctype="multipart/form-data"
            method="post">
