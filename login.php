...
<body class="account-pages">
    ...
    <!-- Begin page -->
    <div class="accountbg"
        style="background: url('front_end_assets/img/banner.jpg');background-size: cover;background-position: center;">
    </div>
    ...
    <div class="wrapper-page account-page-full">
                            ...
                            <div class="form-group m-b-20 row">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" id="emailaddress"
                                        placeholder="Enter your email" name="email" value="<?php if(isset($email)){
                                          echo $email;
                                        } ?>">
                            ...
                            <div class="form-group row m-b-20">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="password" id="password"
                                        placeholder="Enter your password" name="password" value="<?php if(isset($password)){
                                          echo $password;
                                        } ?>">
                                </div>
                            </div>
        ...
        <div class="m-t-40 text-center">
            <p class="account-copyright"><?=date('Y')?> © Panjiyar_Edition </p>
        </div>
