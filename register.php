...
<body class="account-pages">
    ...
    <!-- Begin page -->
    <div class="accountbg"
        style="background: url('front_end_assets/img/banner.jpg');background-size: cover;background-position: center;"></div>
                    ...
                    <div class="card-box p-5">
                        <h2 class="text-uppercase text-center pb-4">
                            <a href="index.php" class="text-success">
                                <span><img src="admin/assets/images/banner.jpg"  alt="" height="26"> Panjiyar_Edition</span>
                            </a>
                        </h2>
                        ...
                        <form class="form-horizontal" action="<?=$_SERVER['PHP_SELF'] ?>" method="post"
                            ...
                            <div class="form-group row m-b-20">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" id="emailaddress" placeholder="panjiyar@gmail.com"
                            ...
                            <div class="form-group row m-b-20">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="password" id="password"
                                        placeholder="Enter 8 length password with number,uppercase and lowercase letter"
                            ...
                            <div class="form-group row m-b-20">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="password" id="cpassword"
                                        placeholder="Enter your password" name="cpassword" value="<?php
                            ...
                            <div class="col-12">
                                <input class="btn btn-block btn-success" type="submit" value="Registration"
                                    name="reg_submit">
                            </div>
